...
Gem::Specification.new do |s|
  s.name = %q{np422-validatable}
  s.version = "1.8.5"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Jay Fields", "John Nunemaker", "Niklas Paulsson"]
  s.date = %q{2011-12-28}
  s.description = %q{Validatable is a library for adding validations.}
  s.email = %q{niklasp@gmail.com}
  s.extra_rdoc_files = [
    "README.rdoc"
  ]
  s.files = [
  ...
  s.homepage = %q{http://github.com/np422/validatable}
  s.require_paths = ["lib"]
