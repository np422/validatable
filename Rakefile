...
Jeweler::Tasks.new do |gem|
  ...
  gem.email       = 'niklasp@gmail.com'
  gem.homepage    = 'http://github.com/np422/validatable'
  gem.authors     = ['Jay Fields', 'John Nunemaker' , 'Niklas Paulsson']
